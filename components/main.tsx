                ...
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        ...
                        <a.div style={mainSpring} className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12 my-10 py-10">
                            ...
                            <Link href='/services' className=""><a className='inline-flex items-center font-semibold tracking-wider transition-colors duration-200 text-teal-400 hover:text-teal-500'>Learn more</a></Link>
                            <Link href='/services'>
                                <svg className="inline-block w-3 ml-2 text-teal-400 hover:cursor-pointer hover:text-teal-500" fill="currentColor" viewBox="0 0 12 12">
