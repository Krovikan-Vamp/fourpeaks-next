...
const UserFunctions = () => {
    ...
    if (localStorage.getItem('userInfo') === null) {
        ...
        user = JSON.parse(getCookie('userInfo'));
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap -m-4">
                            ...
                            <div className="transition-all hover:-translate-y-3 hover:shadow-md h-full bg-gray-200 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <div className="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4">
                                    <span className="text-gray-400 mr-3 inline-flex items-center leading-none text-sm pr-3 py-1 border-r-2 border-gray-200">
                                        ...
                                        </svg>{localStorage.getItem(`physicians`) === null ? `` : JSON.parse(localStorage.getItem(`physicians`)).length}
                                    </span>
                                    <span className="text-gray-400 inline-flex items-center leading-none text-sm">
                                        <svg className="w-4 h-4 mr-1" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                                            <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"></path>
                                        </svg>{localStorage.getItem(`physicians`) === null ? `` : JSON.parse(localStorage.getItem(`physicians`)).length % 15}
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className="p-4 lg:w-1/3 ">
                            <div className="transition-all hover:-translate-y-3 hover:shadow-md h-full bg-gray-200 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">TESTIMONIALS</h2>
                        ...
                        <div className="p-4 lg:w-1/3 ">
                            <div className="transition-all hover:-translate-y-3 hover:shadow-md h-full bg-gray-200 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                ...
                                <p className="leading-relaxed mb-3">Change most information displayed throughout the website, add or delete new information.</p>
                                <a className="text-teal-500 inline-flex items-center">Learn More
                                    <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                        <path d="M5 12h14"></path>
                                        <path d="M12 5l7 7-7 7"></path>
