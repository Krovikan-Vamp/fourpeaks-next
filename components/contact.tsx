...
const Contact = () => {
    const trails = useTrail(3, { from: { opacity: 0, transform: 'translate3d(0,50px,0)' }, opacity: 1, transform: 'translate3d(0,0px,0)', delay: 1500, duration: 1000 });
    ...
    return (
        <section className="text-gray-600 body-font relative min-h-[80vh]">
            <animated.div style={bgSpring} className="transition-all duration-500 absolute inset-0 bg-gray-300 dark:bg-gray-700 contrast-[1.05] dark:invert-[85%] dark:contrast-[1.05] blur-sm hover:blur-none">
            ...
            <animated.div style={trails[0]} className="container px-20 py-24 mx-auto">
                <div className="lg:w-1/2 md:w-1/2 bg-white dark:bg-gray-800 dark:border-gray-600  rounded-xl p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md border-4">
                    <h2 className="text-teal-400 dark:text-teal-500 text-lg mb-1 font-medium title-font">Contact Us</h2>
                    ...
                    <animated.div style={trails[1]} className="p-2 w-full mx-auto">
                        <div className="hover:shadow-lg transition-all hover:cursor-default flex border-2 dark:shadow-gray-700 bg-gray-50 rounded-lg dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 border-gray-300 border-opacity-50 p-8 sm:flex-row flex-col">
